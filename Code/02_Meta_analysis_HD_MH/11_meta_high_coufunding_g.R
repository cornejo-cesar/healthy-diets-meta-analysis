...
depr   <- subset(data, !is.na(depr_z) & unique_statistic == 1 & confounding == "High")
anx    <- subset(data, !is.na(anx_z) & unique_statistic == 1 & confounding == "High")
stress <- subset(data, !is.na(stress_z) & unique_statistic == 1 & confounding == "High")
