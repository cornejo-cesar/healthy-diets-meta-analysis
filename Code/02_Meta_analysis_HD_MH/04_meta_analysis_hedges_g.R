...
#depression_agg <- aggregate(depr_re, cluster = pop_cohort_dataset_id, V = vcov(res_depr, type = "obs"), addk = TRUE)
...
# **1. Create Aggregated Meta-Analysis Results:**
#anxiety_agg <- aggregate(anx_re, cluster = pop_cohort_dataset_id, V = vcov(res_anx, type = "obs"), addk = TRUE)
...
# **1. Create Aggregated Meta-Analysis Results:**
#stress_agg <- aggregate(stress_re, cluster = pop_cohort_dataset_id, V = vcov(res_stress, type = "obs"), addk = TRUE)
...
print("Script '04_meta_analysis_hedges_g.R' ran successfully")
