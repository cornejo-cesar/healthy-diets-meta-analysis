...
depr   <- subset(data, !is.na(depr_z) & unique_statistic == 1 & participation == "High")
anx    <- subset(data, !is.na(anx_z) & unique_statistic == 1 & participation == "High")
stress <- subset(data, !is.na(stress_z) & unique_statistic == 1 & participation == "High")
